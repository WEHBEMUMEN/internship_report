...
\begin{enumerate}
    ...
    \item \textbf{Hyper-Reduction}: Solve the offline-online bottleneck associated with parameter-dependent matrices using the Energy-Conserving Sampling and Weighting (ECSW) method to bypass full-mesh assembly during the online phase.
...
\begin{itemize}
    ...
    \item \textbf{Chapter \ref{ch:conclusion} (Conclusion \& Future Perspectives)}: Summarizes the achievements and outlines future directions for research and optimization.
\end{itemize}
