...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.85, >=stealth]
        ...
        \begin{scope}[xshift=9.2cm]
            ...
            \draw[blue!70!black, ->, >=latex, line width=0.8pt] (3.8, 0.6) -- (3.8, 0.2) node[midway, right] {$d$};
    ...
    \caption{Schematic of the notched cantilever beam: (a) reference configuration $\Omega_0$ showing support and design parameters $x_c$ and $d$; (b) parameterized configuration $\Omega(\boldsymbol{\mu})$.}
...
\begin{align}
    ...
    \hat{k}(\vect{u}, \delta\vect{u}; \boldsymbol{\mu}) &= \int_{\hat{\Omega}} \hat{\boldsymbol{\varepsilon}}(\delta\vect{u})^T \mat{D} \hat{\boldsymbol{\varepsilon}}(\vect{u}) \, J_{\boldsymbol{\mu}}(\hat{\vect{x}}) \, \mathrm{d}\hat{\Omega} \\
