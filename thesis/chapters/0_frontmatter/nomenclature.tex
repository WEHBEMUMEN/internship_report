...
\begin{tabular}{p{2.5cm} p{11.5cm}}
    ...
    $\hat{\Omega}$              & Static, parameter-independent reference configuration domain ($[0,1]^2$) \\
    ...
    $\boldsymbol{\mu} = (r, \mu, \sigma)^T$ & Geometric parameter vector (notch radius, center location, width factor) \\
\end{tabular}
...
\begin{tabular}{p{2.5cm} p{11.5cm}}
    ...
    $\underline{\mathbf{U}}$    & Vector of physical nodal displacements \\
    $\underline{\mathbf{q}}$    & Vector of generalized reduced coordinates \\
    $\widehat{\Omega}$           & Reduced integration domain consisting of ECSW active elements \\
