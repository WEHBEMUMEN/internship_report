...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/6_digital_twin/images/ecsw_mapped_lab.png}
    \caption{Interactive Digital Twin Phase 5.3a mapping lab dashboard. The interface shows a side-by-side comparison of elements highlighted on the naive physical mesh vs. the single reference-mapped ECSW mesh topology along with the selected integration weights.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/6_digital_twin/images/nonlinear_mapped_rom.png}
    \caption{Interactive Digital Twin Phase 5.3b non-linear simulation dashboard, showing the large-displacement cantilever beam deformation comparison, transient stress response, and performance charts under Green-Lagrange strain parameterization.}
