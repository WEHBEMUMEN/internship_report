...
\end{equation}
with initial conditions $\bm{q}_r(0) = \bm{V}_r^\top \hat{\bm{u}}(0)$ and $\dot{\bm{q}}_r(0) = \bm{V}_r^\top \dot{\hat{\bm{u}}}(0)$ (which identically vanish for structures initially at rest), and where the projected operators are:
\begin{align}
