...
\begin{frame}{Project Workflow: Completing the Puzzle}
  ...
  \begin{tikzpicture}[
    ...
    \node [stage] (s1) at (0, 0) {
      \begin{minipage}[t][3.4cm][t]{2.25cm}
        \centering
        \textbf{\normalsize 1. Problem}\\[3pt]
        \color{cnamred!70}\hrule\vspace{4pt}\color{black}
        \textbf{\scriptsize Definition}\\[6pt]
        \raggedright\tiny
        $\bullet$~Defined core goals\\[3pt]
        $\bullet$~Target: $<16\,\text{ms}$ (60 FPS)\\[3pt]
    ...
    \node [stage] (s2) at (2.85, 0) {
      \begin{minipage}[t][3.4cm][t]{2.25cm}
        \centering
        \textbf{\normalsize 2. Planning}\\[3pt]
        \color{cnamred!70}\hrule\vspace{4pt}\color{black}
        \textbf{\scriptsize Gantt Chart}\\[6pt]
        \raggedright\tiny
        $\bullet$~Structured milestones\\[3pt]
        $\bullet$~Built Gantt timeline\\[3pt]
    ...
    \node [stage] (s3) at (5.70, 0) {
      \begin{minipage}[t][3.4cm][t]{2.25cm}
        \centering
        \textbf{\normalsize 3. Research}\\[3pt]
        \color{cnamred!70}\hrule\vspace{4pt}\color{black}
        \textbf{\scriptsize Prior Work}\\[6pt]
        \raggedright\tiny
        $\bullet$~Gathered references\\[3pt]
        $\bullet$~Hughes / Cottrell (IGA)\\[3pt]
    ...
    \node [stage] (s4) at (8.55, 0) {
      \begin{minipage}[t][3.4cm][t]{2.25cm}
        \centering
        \textbf{\normalsize 4. Solving}\\[3pt]
        \color{cnamred!70}\hrule\vspace{4pt}\color{black}
        \textbf{\scriptsize AI + Advisor}\\[6pt]
        \raggedright\tiny
        $\bullet$~Dr.~Hoareau guidance\\[3pt]
        $\bullet$~AI pairing for math\\[3pt]
    ...
    \node [stage, draw=green!60!black, fill=green!5] (s5) at (11.40, 0) {
      \begin{minipage}[t][3.4cm][t]{2.25cm}
        \centering
        \textbf{\normalsize 5. Delivered}\\[3pt]
        \color{green!60!black}\hrule\vspace{4pt}\color{black}
        \textbf{\scriptsize Work Done}\\[6pt]
        \raggedright\tiny
        $\bullet$~Validated FOM solver\\[3pt]
        $\bullet$~$64.5\times$ speedup ($1.3\,\text{ms}$)\\[3pt]
