...
\begin{frame}{Step 1: Reference Pullback Mapping}
  ...
  \begin{block}{Diffeomorphic Pullback to Static $\hat{\Omega}$ (Thesis Section 3.4)}
    ...
    \]
    where $\mat{J}_{\boldsymbol{\xi}}(\boldsymbol{\xi}; \boldsymbol{\mu}) = \frac{\partial \vect{x}}{\partial \boldsymbol{\xi}}$ is the coordinate Jacobian, and \color{cnamred}{$J_{\boldsymbol{\xi}, \boldsymbol{\mu}}(\boldsymbol{\xi}) = \det\mat{J}_{\boldsymbol{\xi}}$} is the mapping weight.
  \end{block}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{alertblock}{The Parameter Dependency ($\mat{K}(\boldsymbol{\mu})$)}
        ...
        \[
          \hat{k}(\vect{u}, \delta\vect{u}; \boldsymbol{\mu}) = \int_{\hat{\Omega}} \left(\mat{J}_{\boldsymbol{\xi}}^{-T} \nabla_{\boldsymbol{\xi}}\vect{u}\right) : \mat{D} : \left(\mat{J}_{\boldsymbol{\xi}}^{-T} \nabla_{\boldsymbol{\xi}}\delta\vect{u}\right) \color{cnamred}{J_{\boldsymbol{\xi}, \boldsymbol{\mu}}} \, d\hat{\Omega}
        \]
