...
\begin{frame}{Introduction \& Motivation}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Dual Scope: Pedagogy \& Research}
        \footnotesize
        \begin{itemize}
          \setlength{\itemsep}{3pt}
          \item \textbf{Pedagogical Impact}: Intuitive, interactive visualizer for structural dynamics in education.
          \item \textbf{Scientific Contribution}: Rigorous testbed for real-time parameterized model order reduction.
        \end{itemize}
      \end{block}
