...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.95, >=stealth]
        ...
        \begin{scope}[xshift=-4.2cm, yshift=0cm, scale=0.75]
        ...
        % CENTER ARROW: Bijective Pullback Diffeomorphism (Clean Gap)
        \draw[<->, ultra thick, primaryblue] (-0.8, 0) -- (0.8, 0) 
        ...
        \begin{scope}[xshift=1.0cm, yshift=0cm, scale=0.75]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{tikzpicture}[scale=0.9, >=stealth]
            ...
            \begin{scope}[xshift=-5.0cm]
                \foreach \x in {0,...,3} {
                    \foreach \y in {0,...,3} {
                        \draw[fill=primaryblue!20, draw=primaryblue!70] (\x*0.5, \y*0.5) rectangle (\x*0.5+0.42, \y*0.42+0.42);
                    }
                }
                \node[below=4pt, font=\small\bfseries] at (1.0, 0) {Full Mesh ($E = 3,200$ elements)};
                \node[right=8pt, font=\small\bfseries, align=left] at (2.1, 1.0) {Evaluate ALL\\3,200 elements};
            \end{scope}
            
            \draw[->, ultra thick, primaryblue] (-1.8, 1.0) -- (-0.8, 1.0) node[midway, above, font=\tiny\bfseries] {Assemble};
            
            % Giant Matrix N x N
            \begin{scope}[xshift=-0.5cm]
                \draw[fill=gray!15, draw=gray!60, thick] (0, 0.1) rectangle (1.8, 1.9) node[midway, font=\small\bfseries] {$\hat{\mat{K}}(\boldsymbol{\mu})$};
                \node[below=4pt, font=\small] at (0.9, 0.1) {$N \times N$ (Full Matrix)};
            \end{scope}

            \draw[->, ultra thick, primaryblue] (1.6, 1.0) -- (2.6, 1.0) node[midway, above, font=\tiny\bfseries] {Project $\boldsymbol{\Phi}^T \cdot \boldsymbol{\Phi}$};

            % Small Matrix r x r
            \begin{scope}[xshift=2.9cm]
                \draw[fill=primaryblue!15, draw=primaryblue, thick] (0, 0.3) rectangle (1.2, 1.7) node[midway, font=\small\bfseries] {$\mat{K}_r$};
                \node[below=4pt, font=\small] at (0.6, 0.3) {$r \times r$};
            \end{scope}
        \end{tikzpicture}
        \caption{Unreduced Galerkin ROM: Full assembly $\mathcal{O}(E)$ over all 3,200 elements ($0.92\times$ speedup).}
        \vspace{0.3cm}
    \end{subfigure}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{tikzpicture}[scale=0.9, >=stealth]
            ...
            \begin{scope}[xshift=-5.0cm]
                \foreach \x in {0,...,3} {
                    \foreach \y in {0,...,3} {
                        \draw[fill=white, draw=gray!30] (\x*0.5, \y*0.5) rectangle (\x*0.5+0.42, \y*0.42+0.42);
                    }
                }
                % Highlighted active elements
                \draw[fill=green!50!black!40, draw=green!60!black] (0*0.5, 2*0.5) rectangle (0*0.5+0.42, 2*0.5+0.42) node[midway, font=\small\bfseries] {$w_1$};
                \draw[fill=green!50!black!40, draw=green!60!black] (2*0.5, 3*0.5) rectangle (2*0.5+0.42, 3*0.5+0.42) node[midway, font=\small\bfseries] {$w_2$};
                \draw[fill=green!50!black!40, draw=green!60!black] (3*0.5, 1*0.5) rectangle (3*0.5+0.42, 1*0.5+0.42) node[midway, font=\small\bfseries] {$w_3$};
                
                \node[below=4pt, font=\small\bfseries] at (1.0, 0) {Active Subset ($E^* = 28$ elements)};
                \node[right=8pt, font=\small\bfseries, text=green!50!black, align=left] at (2.1, 1.0) {Evaluate ONLY\\28 active elements};
            \end{scope}
            
            % Direct arrow to small matrix
            \draw[->, ultra thick, green!60!black] (-1.8, 1.0) -- (2.6, 1.0) node[midway, above, font=\tiny\bfseries, text=green!60!black] {Direct Assembly $\sum_{e \in E^*} w_e \boldsymbol{\Phi}_e^T \mat{K}_e \boldsymbol{\Phi}_e$};

            % Small Matrix r x r
            \begin{scope}[xshift=2.9cm]
                \draw[fill=green!15, draw=green!60!black, thick] (0, 0.3) rectangle (1.2, 1.7) node[midway, font=\small\bfseries] {$\mat{K}_r$};
                \node[below=4pt, font=\small] at (0.6, 0.3) {$r \times r$};
            \end{scope}

            % Crossed out giant matrix area (Bypassed)
            \begin{scope}[xshift=-0.5cm]
                \draw[dashed, gray!40, thick] (0, 0.1) rectangle (1.8, 1.9);
                \node[gray!40, font=\small\bfseries] at (0.9, 1.0) {BYPASSED};
                \draw[red!60, ultra thick] (0.1, 0.2) -- (1.7, 1.8);
                \draw[red!60, ultra thick] (0.1, 1.8) -- (1.7, 0.2);
            \end{scope}
        \end{tikzpicture}
        \caption{Reference-Mapped ECSW Hyper-reduction: Bypasses $N \times N$ assembly entirely ($64.5\times$ speedup).}
    \end{subfigure}
    \caption{Structural mechanics comparison between Unreduced Galerkin ROM (top) and Reference-Mapped ECSW Hyper-reduction (bottom).}
