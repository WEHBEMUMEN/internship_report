...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.1, >=stealth]
        ...
        \draw[<->, ultra thick, primaryblue] (-0.6, 0) -- (0.6, 0) 
        ...
        \begin{scope}[xshift=0.8cm, yshift=0cm, scale=0.85]
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.49\textwidth}
        ...
        \begin{tikzpicture}[scale=0.92, >=stealth]
            ...
            \node[below, font=\small] at (2.8, -1.65) {$r \times r$};
        \end{tikzpicture}
