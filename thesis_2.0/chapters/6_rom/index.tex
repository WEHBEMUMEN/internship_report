...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.95, >=stealth]
        \begin{scope}[xshift=-3.75cm, yshift=0cm, scale=0.7]
            ...
            \shade[left color=primaryblue, middle color=accentcyan, right color=yellow!80!orange] 
            (-3, -1) -- (-1.2, -1) .. controls (-0.6, -1.0) and (-0.4, -0.6) .. (0, -0.6)
            .. controls (0.4, -0.6) and (0.6, -1.2) .. (1.2, -1.2) -- (3, -1.5) -- (3, 0.5) -- (1.2, 0.8)
            .. controls (0.6, 0.8) and (0.4, 0.2) .. (0, 0.2) .. controls (-0.4, 0.2) and (-0.6, 1.0) .. (-1.2, 1.0) -- (-3, 1) -- cycle;
            \foreach \y in {-0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75} {
                \draw[white, opacity=0.35, thin] (-3, \y) .. controls (-1.2, \y) and (-0.5, \y*0.4 - 0.2) .. (0, \y*0.4 - 0.2) .. controls (0.5, \y*0.4 - 0.2) and (1.2, \y - 0.25) .. (3, \y - 0.5);
            }
        \end{scope}
        ...
        \begin{scope}[xshift=3.75cm, yshift=0cm, scale=0.7]
            ...
            (-3, -1) -- (-1.2, -1) .. controls (-0.6, -1.0) and (-0.4, -0.4) .. (0, -0.4)
            .. controls (0.3, -0.4) and (0.5, -1.0) .. (1.2, -1.0) -- (3, -1.0) -- (3, 1.0) -- (1.2, 1.0)
            .. controls (0.6, 1.0) and (0.4, 0.4) .. (0, 0.4) .. controls (-0.4, 0.4) and (-0.6, 1.0) .. (-1.2, 1.0) -- (-3, 1.0) -- cycle;
            \foreach \y in {-0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75} {
                \draw[white, opacity=0.35, thin] (-3, \y) -- (3, \y);
            }
        \end{scope}
    \end{tikzpicture}
    \caption{Interactive Digital Twin mapping dashboard comparing physical domain deformation $\Omega(\boldsymbol{\mu})$ (left) with static reference pullback domain $\hat{\Omega}$ (right).}
