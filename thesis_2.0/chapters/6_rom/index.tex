...
This section formulates spatial state projection onto POD bases extracted via Singular Value Decomposition (SVD) and analyzes singular value energy decay.
...
This section details how transient state vectors are re-projected across parameter updates to prevent non-physical displacement discontinuities during interactive slider adjustments.
...
This section formulates Energy-Conserving Sampling and Weighting (ECSW) to bypass full-mesh assembly loops by selecting an optimal sparse element subset $E^*$.
...
This section presents quantitative benchmarks comparing FOM, Galerkin ROM, and ECSW hyper-reduction in terms of solve speed, $L_2$ accuracy, and WebGL frame rates.
...
This section synthesizes the performance achievements of the IGA-ROM-ECSW engine and previews the thesis conclusions in Chapter \ref{ch:conclusion}.
