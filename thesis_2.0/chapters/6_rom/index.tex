...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.9, >=stealth]
        ...
        \begin{scope}[xshift=-4.5cm, yshift=0cm, scale=0.7]
            ...
            \node[font=\tiny, text=black!70] at (2.5, -1.2) {Notched Geometry $\boldsymbol{\mu} = (x_c, r)$};
        \end{scope}

        % CENTER ARROW: Bijective Pullback Diffeomorphism (Clean Gap)
        \draw[<->, ultra thick, primaryblue] (-0.7, 0) -- (0.7, 0) 
            node[midway, above=2pt, font=\small\bfseries] {$\boldsymbol{\Psi}(\hat{\vect{x}}; \boldsymbol{\mu})$} 
            node[midway, below=2pt, font=\tiny, text=black!70] {Bijective Pullback};

        % RIGHT PANEL: Static Rectangular Reference Domain \hat{\Omega}
        \begin{scope}[xshift=1.0cm, yshift=0cm, scale=0.7]
            ...
            \node[font=\tiny, text=black!70] at (2.5, -1.2) {Invariant Grid $[0,L] \times [0,H]$};
        \end{scope}
    \end{tikzpicture}
