...
Figure \ref{fig:nurbs_curves_eval} illustrates quadratic B-spline basis functions $N_{i,2}(\xi)$ evaluated over an open knot vector.
...
Figure \ref{fig:hrefinement_basis} demonstrates $h$-refinement (knot insertion), showing how the control polygon refines while preserving exact curve geometry.
